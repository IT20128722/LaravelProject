    ...
    <tbody class="text-danger bg-light fs-5">
      ...
      <tr>
        <form action="updatedelete" method="get">
          <td class="text-black fs-6 fw-bold pt-4"><input type="hidden" name="id" value="{{$item['Id']}}">{{$item['Id']}}</td>
          ...
          <td><img src="images/{{$item['PImage']}}" width="100px" height="100px" alt="image"></td>
